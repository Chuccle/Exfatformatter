...
/* C:\Users\charlie.cohen\Desktop\10mb windows.mnt (20/09/2022 11:12:05)
   StartOffset(h): 00021800, EndOffset(h): 00022ECF, Length(h): 000016D0 */
...
private:
	...
	static unsigned long xsum32(unsigned char dat,	unsigned long sum);
	uint32_t m_upcaseSector;
	uint32_t m_upcaseChecksum;
	uint32_t m_upcaseSize;
	uint32_t m_headerOffset;
	uint8_t m_secBuf[512];
	uint8_t m_bytesPerSectorShift;
